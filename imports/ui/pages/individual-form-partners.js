...
import './individual-form-partners.html';
...
Template.IndividualFormPartners_page.rendered = function () {
    $("form[data-persist='garlic']").garlic();
};
Template.IndividualFormPartners_page.onDestroyed(function onDestroyIndividualForm_page(){
    if(somethingChanged === true){
        alert("The information you have entered will be saved");
        somethingChanged = false;
    }});
Template.IndividualFormPartners_page.onCreated(function onCreatedIndividualFormPage() {
    somethingChanged = false;

    Template.IndividualFormPartners_page.helpers({
        partners() {
...
Template.IndividualFormPartners_page.events({
    ...
    'submit .form': function (event, template) {
        ...
        try {
            Images.insert(logoFile, (error, imageDocument) => {
                ...
                Meteor.call('individualsPartners.insert', { name, Id, owner, linkedIn, telephone, skype, position, bio, projectsNot, partnersNot, projects, partners, logo });
            });
