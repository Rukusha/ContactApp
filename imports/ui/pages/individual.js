...
Template.Individual_page.rendered = function () {
    $("form[data-persist='garlic']").garlic();
};

Template.Individual_page.onDestroyed(function onDestroyIndividualFormPage(){
...
Template.Individual_page.onCreated(function onCreatedIndividualFormPage() {
    somethingChanged = false;
...
Template.Individual_page.helpers({
...
Template.Individual_page.events({
    ...
    'submit .form': function (event, template) {
        ...
        try {
            Images.insert(logoFile, (error, imageDocument) => {
                ...
                Meteor.call('individuals.insert', { name, Id, owner, twitter, facebook, linkedIn, telephone, skype, position, bio, projectsNot, partnersNot, projects, partners, logo });
            });
